...
class MyHeaders(object):
    ...
    def user_agents(self, request, spider):
        ...
        # 设置登录信息（此处可动态获取）
        request.headers['Authorization'] = 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZGVudGl0eSI6Miwic2NvcGUiOiJsaW4iLCJ0eXBlIjoiYWNjZXNzIiwiZXhwIjoxNjc2NTU1NDcxfQ.a5viWxHJrsijjNbI1qdmwHUu994oqO9wXiwq7zVdaAc'
